        ...
        public void onCallStateChanged(int state, String incomingNumber) {
            ...
            switch (state) {
                case TelephonyManager.CALL_STATE_IDLE:
                    Toast.makeText(CallActivity.this, "Đang Ở Trạng Thái Rãnh", Toast.LENGTH_SHORT).show();
                    break;
                case TelephonyManager.CALL_STATE_RINGING:
                    Toast.makeText(CallActivity.this, "Có Cuộc Gọi Đến", Toast.LENGTH_SHORT).show();
                    break;
                case TelephonyManager.CALL_STATE_OFFHOOK:
                    Toast.makeText(CallActivity.this, "Đang Trong Cuộc Gọi", Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    };
